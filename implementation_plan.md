...
- Shared empty state for memory and community list surfaces
- Screen reader heading semantics for app and shared state titles
...
- [x] Add verified institution admin flow.
- [x] Add alumni domain validation.
- [x] Add campus building sub-zones.
- [x] Add era groups.
...
- [x] Notify users of accepted transfers.
- [x] Notify users when tagged in memories.
- [x] Notify users of community invitations.
...
- [x] Verify screen reader navigation.
- [x] Add empty states.
- [x] Add loading states.
- [x] Add error recovery states.
- [x] Polish dark theme.
- [x] Polish aura animations.
- [x] Reduce UI chrome in AR mode.
...
- [x] Add analytics with privacy review.
...
- [x] Store geohash and exact coordinates.
